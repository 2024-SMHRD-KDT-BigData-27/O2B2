	...
	<form action="RegisterProductService" method="post">
		<div class="total">
			...
			<div class="details">
				...
				<div><label for="purchaseDate">카테고리:</label> <select name="category">
					<option>유모차</option>
					<option>옷</option>
					</select></div> 
				...
				<div class="age"><label for="age">나이:</label> <input type="number"
					id="age" name="min-age" placeholder="예: 3" min="0"> ~ <input
					type="number" id="age" name="max-age" placeholder="예: 3" min="0"></div>
				<br>
